...
def get_parser(name='TextRecog Dataset Generation') -> argparse.ArgumentParser:
...
def parse_options():
    ...
    with open(args.options) as f:
        ...
        if not options['mmocr_dataset_generation']:
            assert False, "wrong option file type!"

    dataset_options = options['mmocr_dataset_generation']
