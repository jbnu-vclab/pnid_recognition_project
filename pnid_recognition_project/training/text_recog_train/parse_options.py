...
def parse_options():
    ...
    with open(args.options) as f:
        ...
        if not options['pnid_text_recog_train']:
            assert False, "wrong option file type!"

    train_options = options['pnid_text_recog_train']
    ...
    if not os.path.exists(train_options['work_dir']):
        os.mkdir(train_options['work_dir'])
